...
public class BusStopDatabase extends SQLiteOpenHelper {
    private static final String DATABASE_PATH = "/data/data/com.example.gio.bigproject/databases/";
    private static final int DATABASE_VERSION = 2;
    private static final String DATABASE_CREATED = "Initial database is created";
    private static final String DATABASE_COPY_ERROR = "Error copying database";
    ...
    public BusStopDatabase(Context context) {
        ...
        if (checkDataBase()) {
            ...
            try {
                ...
                throw new Error(DATABASE_COPY_ERROR);
            }
            Toast.makeText(context, DATABASE_CREATED, Toast.LENGTH_LONG).show();
        }
    }
